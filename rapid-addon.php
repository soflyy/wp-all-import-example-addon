...
$addon->set_metabox_function(''); // optional, only if you need to display a custom metabox ??

code to make it auto-install WP All Import, display error if WP All Import isn't installed, etc.
